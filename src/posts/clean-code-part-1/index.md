...
Что такое чистый код? Вот как некоторые из наших известных коллег объясняют, что такое чистый код:
...
>
> _Греди Буг, автор книги «Object oriented, analysis and design with applications»_

> «Чистый код всегда выклядит так, словно его автор над ним тщательно потрудился...»
>
> _Майкл Физерс, «Working effectively with legacy code»_
